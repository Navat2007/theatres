        ...
        <div className='content__section'>
            <div className="content__title-block">
                <Button
                    ...
                    aria-label="Назад"
                />
                <h1 className="content__title --mb-small">Создание афиши</h1>
            </div>
            <form className='form'>
                <Tabs>
                    <Tab index={1} title={"Основная информация"} extraClass='form__tab form__container --view-one-column'>
                    ...
                    <Tab index={2} title={"Описание"} extraClass='form__tab'>
                        <Controller
                            control={control}
                            name="editor"
                            defaultValue={""}
                    ...
                    <Tab index={3} title={"Афиша"} extraClass='form__tab'>
                        <fieldset className='form__section'>
                    ...
                    <Tab index={4} title={"Программка"} extraClass='form__tab'>
                        <fieldset className='form__section'>
                            <div className="form__field-block">
                                <FieldInput
                                    label={"Ссылка на фото"}
                    ...
                    <Tab index={5} title={"Фото"} extraClass='form__tab'>
                        <fieldset className='form__section'>
                            <div className="form__field-block">
                                <FieldInput
                                    label={"Ссылка на фото"}
                    ...
                    <Tab index={6} title={"Видео анонс-приглашение"} extraClass='form__tab'>
                        <fieldset className='form__section'>
                            <div className="form__field-block">
                                <FieldInput
                                    label={"Ссылка на фото"}
                    ...
                    <Tab index={7} title={"Показы"} extraClass='form__tab form__container --view-one-column'>
                        <fieldset className='form__section'>
