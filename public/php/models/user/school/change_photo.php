...
if(isset($_FILES['files']))
{
    ...
    $baseDirName = $_SERVER['DOCUMENT_ROOT'] . "/files/school";
    ...
    foreach($_FILES['files']['error'] as $key => $error)
    {
        if ($error == UPLOAD_ERR_OK)
        {
            ...
            $dirName = $_SERVER['DOCUMENT_ROOT'] . "/files/school/" . $id;
            ...
            $path = $_SERVER['DOCUMENT_ROOT'] . "/files/school/" . $id . "/" . $file_token . "_" . $name;
            ...
            {
                $file_to_DB = "/files/school/" . $id . "/" . $file_token . "_" . $name;
